...
def parse_args():
    ...
    parser.add_argument('--file_name', type=str, default = 'submit_swin.csv')
    parser.add_argument('--config_path', type=str, default = 'work_dirs/swin/swin90.19_second_Train_config.py')
    parser.add_argument('--ckpt_path', type=str, default = 'work_dirs/swin/swin90.19_second_Train_iter_158000.pth')
    #드라이브에서 다운 후 지정
