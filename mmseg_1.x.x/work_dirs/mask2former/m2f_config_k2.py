...
data_root = '/raid/pixelteam/satellite3/kfold/fold_2'
crop_size = (
    512,
    512,
)
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/raid/pixelteam/mmsegmentation/configs/_sh_/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth'
        ),
...
pretrained = '/raid/pixelteam/mmsegmentation/configs/_sh_/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth'
depths = [
    2,
    2,
    18,
...
launcher = 'pytorch'
work_dir = './work_dirs/mask2former_config_k2'
