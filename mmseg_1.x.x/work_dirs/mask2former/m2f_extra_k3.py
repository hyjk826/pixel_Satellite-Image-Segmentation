...
data_root = '/home/jovyan/work/datasets/satellite3/kfold/fold_3'
...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            '/home/jovyan/work/work_space/mjh/mmsegmentation/configs/_m2f/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
pretrained = '/home/jovyan/work/work_space/mjh/mmsegmentation/configs/_m2f/swin_large_patch4_window12_384_22k_20220412-6580f57d.pth'
resume = False
test_cfg = dict(type='TestLoop')
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        data_prefix=dict(img_path='valid', seg_map_path='anno_valid_img_gray'),
        data_root='/home/jovyan/work/datasets/satellite3/kfold/fold_3',
        pipeline=[
...
train_dataloader = dict(
    batch_size=2,
    dataset=dict(
        data_prefix=dict(img_path='train', seg_map_path='anno_train_img_gray'),
        data_root='/home/jovyan/work/datasets/satellite3/kfold/fold_3',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/mask2former_config_k3'
